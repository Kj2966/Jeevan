			...
			<main class="main">
					...
					<div class="promo-slider">
						<div class="promo-slider__item promo-slider__item--style-1">
							<picture>
								...
								<source srcset="img/homeHero.jpg" media="(min-width: 376px)"/><img class="img--bg" src="img/homeHero.jpg" alt="img"/>
							</picture>
							<div class="container">
								<div class="row">
									<div class="col-12">
										<div class="align-container">
											<div class="align-container__item">
												<div class="promo-slider__wrapper-1">
													<h2 class="promo-slider__title"><span>JEEVAN</span> </br><span>A Life After Life.</span></h2>
												</div>
												<div class="promo-slider__wrapper-2">
													<p class="promo-slider__subtitle">Extend your legacy: Gift life beyond yours through organ donation, shaping futures from the generosity of your existence.</p>
												</div>
						...
						<div class="promo-slider__item promo-slider__item--style-2">
							<picture>
								<source srcset="img/homeHero2.jpg" media="(min-width: 835px)"/>
								<source srcset="img/homeHero2.jpg" media="(min-width: 376px)"/><img class="img--bg" src="img/homeHero2.jpg" alt="img"/>
							</picture>
							<div class="container">
								<div class="row">
									<div class="col-xl-7">
										<div class="align-container">
											<div class="align-container__item">
												<div class="promo-slider__wrapper-1">
													<h2 class="promo-slider__title"><span>Donor</span><br/><span>Give the gift of life: Be an organ donor.</span></h2>
												</div>
												<div class="promo-slider__wrapper-2">
													<p class="promo-slider__subtitle">In the twilight of life, let your legacy illuminate pathways of hope. Donate organs, igniting a beacon of life beyond life's horizon.</p>
												</div>
												<div class="promo-slider__wrapper-3"><a class="button promo-slider__button button--primary" href="#">Discover</a></div>
											</div>
										</div>
						...
						<div class="promo-slider__item promo-slider__item--style-3">
							<picture>
								<source srcset="img/heroHome3.jpg" media="(min-width: 835px)"/>
								<source srcset="img/heroHome3.jpg" media="(min-width: 376px)"/><img class="img--bg" src="img/heroHome3.jpg" alt="img"/>
							</picture>
							<div class="container">
								<div class="row">
									<div class="col-xl-8 offset-xl-2">
										<div class="align-container">
											<div class="align-container__item">
												<div class="promo-slider__wrapper-1">
													<h2 class="promo-slider__title"><span>Help Others</span><br/><span>Around the world.</span></h2>
												</div>
												<div class="promo-slider__wrapper-2">
													<p class="promo-slider__subtitle">Even beyond our earthly journey, organ donation ensures our legacy endures, granting others the chance to live on, embracing hope and new beginnings beyond our time.</p>
												</div>
												<div class="promo-slider__wrapper-3"><a class="button promo-slider__button button--primary" href="#">Discover</a></div>
											</div>
										</div>
						...
						<div class="row align-items-center">
							<div class="col-lg-6">
								<div class="heading heading--primary"><span class="heading__pre-title">About Us</span>
									<h2 class="heading__title"><span>Empowering organ donation awareness </span> <span>Our mission, your support.</span></h2>
								</div>
								<p><strong>Our Mission: Guiding you through the journey of organ donation awareness, providing support, and fostering impactful change in our communities.</strong></p>
								<p>In our endeavor to raise organ donation awareness, we facilitate donor and patient registration, maintain waiting lists, and ensure equitable resource allocation. </p>
								<p>Together, we aim to bridge gaps, offer hope, and save lives through informed action and compassionate support.</p><a class="button button--primary" href="about.php">More About</a>
							</div>
							<div class="col-lg-6 col-xl-5 offset-xl-1" > 
								<div class="info-box"><img class="img--layout" src="img/about_layout.png" alt="img"/><img class="img--bg" src="img/aboutIntro.jpg" alt="img"/>
									<h4 class="info-box__title">Inspiring donors, changing lives</h4>
									<p>Dedicated to saving lives through organ donation: Together, we create hope, one donor at a time.</p><a class="info-box__link" href="donorRegistration.php">Become a Donor</a>
								</div>
							</div>
						</div>
					</div>
				...
				<section class="section icons-section no-padding-top">
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-6 col-lg-3">
								<div class="icon-item">
									<div class="icon-item__img"><img class="img--layout" src="img/icon_2-2.png" alt="img"/>
										<svg class="icon icon-item__icon " style="color: #F76466;">
							...
							<div class="col-6 col-lg-3">
								<div class="icon-item">
									<div class="icon-item__img"><img class="img--layout" src="img/icon_8-8.png" alt="img"/>
										<svg class="icon icon-item__icon icon--green">
											<use xlink:href="#donate-1"></use>
										</svg>
									</div>
									<div class="icon-item__text">
										<p>Donating Platform</p>
									</div>
								</div>
							</div>
							<div class="col-6 col-lg-3">
								<div class="icon-item">
									<div class="icon-item__img"><img class="img--layout" src="img/svg/icons_4/3_love.svg" alt="img"/>
										<svg class="icon icon-item__icon " style="color: #F76466;">
						...
						<div class="row align-items-end">
							<div class="col-xl-5">
								<div class="heading heading--primary"><span class="heading__pre-title">What we Do</span>
									<h2 class="heading__title"><span>Empowering Lives</span> <span>Our Organ Donation Commitment</span></h2>
									<p>Our mission is simple yet profound: we facilitate organ donation, connect donors with those in need, maintain transparent waiting lists, and ensure fair resource allocation. With compassion and dedication, we empower individuals to save lives and leave a lasting legacy of hope and healing in our communities</p>
								</div>
							</div>
									...
									<div class="col-6">
										<div class="counter-item counter-item--style-3">
											<div class="counter-item__top">
												<h6 class="counter-item__title">Patients We Helped in 2024</h6>
											</div>
											<div class="counter-item__lower"><span class="js-counter">100</span><span>+</span></div>
										</div>
									</div>
									<div class="col-6">
										<div class="counter-item counter-item--style-3">
											<div class="counter-item__top">
												<h6 class="counter-item__title">Organs We Collected</h6>
											</div>
											<div class="counter-item__lower"><span class="js-counter">65</span><span>+</span></div>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="causes-slider offset-margin">
									...
									<div class="causes-item causes-item--primary">
										<div class="causes-item__body">
											<div class="causes-item__top">
												<h6 class="causes-item__title"> <a href="cause-details.html">Blood Donation</a></h6>
												<p>Ahmedabad Uniting hearts and hands in a lifesaving blood donation campaign for our community's well-being.</p>
											</div>
											<div class="causes-item__img">
												<div class="causes-item__badge" style="background-color: #49C2DF">Blood Donation</div><img class="img--bg" src="img/bloodDonation.jpg" alt="img"/>
											</div>
											<div class="causes-item__lower">
												...
												<div class="causes-item__details-holder">
													<div class="causes-item__details-item"><span>Goal: </span><span>50 Ltrs</span></div>
													<div class="causes-item__details-item text-right"><span>Pledged: </span><span>40 Ltrs</span></div>
												</div>
											</div>
										</div>
								...
								<div class="causes-slider__item">
									<div class="causes-item causes-item--primary">
										<div class="causes-item__body">
											<div class="causes-item__top">
												<h6 class="causes-item__title"> <a href="cause-details.html">Liver Donation</a></h6>
												<p>Surat hosts a crucial liver donation initiative, offering hope and renewed life to those in need.</p>
											</div>
											<div class="causes-item__img">
												<div class="causes-item__badge" style="background-color: #F36F8F">Liver Donation</div><img class="img--bg" src="img/liverDonation.jpg" alt="img"/>
											</div>
											<div class="causes-item__lower">
												<div class="progress-bar">
												...
												<div class="causes-item__details-holder">
													<div class="causes-item__details-item"><span>Goal: </span><span>20</span></div>
													<div class="causes-item__details-item text-right"><span>Pledged: </span><span>10</span></div>
												</div>
											</div>
										</div>
										<!-- <a class="button causes-item__button button--primary" href="#">+ Donate</a> -->
								...
								<div class="causes-slider__item">
									<div class="causes-item causes-item--primary">
										<div class="causes-item__body">
											<div class="causes-item__top">
												<h6 class="causes-item__title"> <a href="cause-details.html">Eyes Donation</a></h6>
												<p>Mumbai shines bright with compassion as it embraces an eye donation campaign, illuminating paths to vision and hope.</p>
											</div>
											<div class="causes-item__img">
												<div class="causes-item__badge" style="background-color: #2EC774">Eyes donation</div><img class="img--bg" src="img/eyeDonation.jpg" alt="img"/>
											</div>
											<div class="causes-item__lower">
												<div class="progress-bar">
													<div class="progress-bar__inner" style="width: 60%;">
														<div class="progress-bar__value">60%</div>
													</div>
												</div>
												<div class="causes-item__details-holder">
													<div class="causes-item__details-item"><span>Goal: </span><span>10</span></div>
													<div class="causes-item__details-item text-right"><span>Pledged: </span><span>6</span></div>
												</div>
											</div>
										</div>
										<!-- <a class="button causes-item__button button--primary" href="#">+ Donate</a> -->
								...
								<div class="causes-slider__item">
									<div class="causes-item causes-item--primary">
										<div class="causes-item__body">
											<div class="causes-item__top">
												<h6 class="causes-item__title"> <a href="cause-details.html">Heart Donation</a></h6>
												<p>Udaipur pulsates with compassion, hosting a heart donation drive to ignite hope and save lives.</p>
											</div>
											<div class="causes-item__img">
												<div class="causes-item__badge" style="background-color: #F8AC3A">Heart Donation</div><img class="img--bg" src="img/heartDonation.jpg" alt="img"/>
											</div>
											<div class="causes-item__lower">
												<div class="progress-bar">
													<div class="progress-bar__inner" style="width: 30%;">
														<div class="progress-bar__value">30%</div>
													</div>
												</div>
												<div class="causes-item__details-holder">
													<div class="causes-item__details-item"><span>Goal: </span><span>10</span></div>
													<div class="causes-item__details-item text-right"><span>Pledged: </span><span>3</span></div>
												</div>
											</div>
										</div>
										<!-- <a class="button causes-item__button button--primary" href="#">+ Donate</a> -->
						...
						<div class="row align-items-end margin-bottom">
							<div class="col-lg-9">
								<div class="heading heading--primary"><span class="heading__pre-title">What we Did</span>
									<h2 class="heading__title"><span>Donation</span> <span>Awareness and Projects</span></h2>
									<p class="no-margin-bottom">We spearheaded nationwide donation awareness and camps, comprising multifaceted projects aimed at fostering impactful change and saving lives.</p>
								</div>
							</div>
						</div>
					</div>
					<div class="row no-gutters projects-masonry">
						<div class="col-lg-6 col-xl-4 projects-masonry__item projects-masonry__item--height-1 projects-masonry__item--vertical">
							...
							<div class="projects-masonry__text" style="background-color: #2EC774;">
								<div class="projects-masonry__inner"><span class="projects-masonry__badge" style="background: #49C2DF;">Donated Blood Delivery</span>
									<h3 class="projects-masonry__title"> <a href="cause-details.html">More than One Life Changed</a></h3>
									<p>50 liters delivered to hospitals and blood banks in Rajkot, ensuring ample supply for patients in need of lifesaving transfusions</p>
									<div class="projects-masonry__details-holder">
										<div class="projects-masonry__details-item"><span>Goal: </span><span>50 Ltrs</span></div>
										<div class="projects-masonry__details-item"><span>Date: </span><span>23 Jan 2024</span></div>
									</div>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-xl-8 projects-masonry__item projects-masonry__item--height-2 projects-masonry__item--horizontal">
							...
							<div class="projects-masonry__text" style="background-color: #9BC35E;">
								<div class="projects-masonry__inner"><span class="projects-masonry__badge" style="background: #F36F8F;">Donated Liver Distribution</span>
									<h3 class="projects-masonry__title"> <a href="cause-details.html">Livers donated, lives transformed:</a></h3>
									<p>Distributed donated livers across Ahmedabad's hospitals, ensuring equitable access to life-saving transplants for patients in need</p>
									<div class="projects-masonry__details-holder">
										<div class="projects-masonry__details-item"><span>Goal: </span><span>20</span></div>
										<div class="projects-masonry__details-item"><span>Date: </span><span>23 Dec'23</span></div>
									</div>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-xl-8 projects-masonry__item projects-masonry__item--height-1 projects-masonry__item--primary">
							<div class="projects-masonry__img"><img class="img--bg" src="img/seminar.jpg" alt="img"/>
								<div class="projects-masonry__inner"><span class="projects-masonry__badge" style="background: #F8AC3A;">Awareness</span>
									<h3 class="projects-masonry__title"> <a href="cause-details.html">Embarking on a transformative journey, our organ donation awareness camp cultivates hope and compassion within our community's core. </p>
									<!-- <div class="projects-masonry__details-holder">
						...
						<div class="col-lg-6 col-xl-4 projects-masonry__item projects-masonry__item--height-2 projects-masonry__item--primary">
							<div class="projects-masonry__img"><img class="img--bg" src="img/eyeDonated.jpg" alt="img"/>
								<div class="projects-masonry__inner"><span class="projects-masonry__badge" style="background: #F36F8F;">Eyes</span>
									<h3 class="projects-masonry__title"> <a href="cause-details.html">Donate Eye Distribution</a></h3>
									<p>Fulfilling a vision of hope, reaching those in need across communities with life-changing opportunities.</p>
									<div class="projects-masonry__details-holder">
										<div class="projects-masonry__details-item"><span>Goal: </span><span>10</span></div>
										<div class="projects-masonry__details-item"><span>Date: </span><span>26 Feb'24</span></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row margin-bottom">
							<div class="col-12">
								<div class="heading heading--primary heading--center"><span class="heading__pre-title">Events</span>
									<h2 class="heading__title"><span>Jeevan Org Held</span> <span>for You</span></h2>
									<p class="no-margin-bottom">Jeevan spearheaded a multitude of impactful awareness and recognition events, spanning across the entire county, fostering widespread community engagement</p>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 col-lg-4">
								<div class="event-item">
									<div class="event-item__img"><img class="img--bg" src="img/awareness1.jpg" alt="img"/></div>
									<div class="event-item__content">
										<h6 class="event-item__title"><a href="#">Medical Awareness Camp </a></h6>
										<p><b>Sterling Hospital,</b> Rajkot</p>
										<p><b>January 30</b> 2024</p>
							...
							<div class="col-md-6 col-lg-4">
								<div class="event-item">
									<div class="event-item__img"><img class="img--bg" src="img/awareness2.jpg" alt="img"/></div>
									<div class="event-item__content">
										<h6 class="event-item__title"><a href="#">Appreciation Event For Donors</a></h6>
										<p><b>Gandhinagar,</b> Gujarat</p>
										<p><b>March 22 </b> 2024</p>
										<!-- <p><b>10:00 AM - 18:00 PM,</b> Everyday</p> -->
									</div>
								</div>
							</div>
							<div class="col-md-6 col-lg-4">
								<div class="event-item">
									<div class="event-item__img"><img class="img--bg" src="img/awareness3.jpg" alt="img"/></div>
									<div class="event-item__content">
										<h6 class="event-item__title"><a href="#">Hospital Visit</a></h6>
										<p><b>Apollo Hospital,</b> Ahmedabad</p>
										<p><b>March 29 ,</b> 2024</p>
					...
					<div class="container">
						...
						<div class="row">
							<div class="col-lg-8 offset-lg-4 col-xl-7 offset-xl-4">
								<h3 class="text-section__title">Delivering help ,hope and life </h3>
								<p>Make a difference Volunteer, donate organs, and be the catalyst for transforming lives, one selfless act at a time.</p><a class="button button--primary" href="#">Become a Volunteer</a>
							</div>
						</div>
					</div>
				</section>
				...
				<section class="section testimonials--style-2">
					<div class="testimonials--style-2__bg jarallax">
						<picture>
							<source srcset="img/testimonials_2.jpg" media="(min-width: 992px)"/><img class="jarallax-img" src="img/volenteer.jpg" alt="img"/>
						</picture>
					</div>
					<div class="container">
						<div class="row">
								...
								<div class="testimonials-slider testimonials-slider--style-2">
									<div class="testimonials-slider__item">
										...
										<div class="testimonials-slider__text">
											<p>Joining Jeevan was a decision that changed my life. Their dedication to raising awareness about organ donation is unmatched. As a volunteer, I've had the privilege of witnessing the incredible impact of their initiatives firsthand. From organizing awareness campaigns to conducting donor registration drives, Jeevan's efforts have touched countless lives. I am proud to be a part of an organization that is committed to making a difference in our community and beyond.</p>
											<div class="testimonials-slider__author"><span class="testimonials-slider__name">Vrunda Gadhvi, </span><span class="testimonials-slider__position">Volunteer</span></div>
										</div>
									</div>
									<div class="testimonials-slider__item">
										<div class="testimonials-slider__icon">“</div>
										<div class="testimonials-slider__text">
											<p>Jeevan's work in organ donation advocacy is nothing short of inspiring. As a volunteer, I've had the opportunity to contribute to their mission and see the positive impact they have on individuals and families in need. From providing support to those awaiting transplants to raising awareness about the importance of organ donation, Jeevan is truly making a difference in people's lives.</p>
											<div class="testimonials-slider__author"><span class="testimonials-slider__name">Akhani Purva</span><span class="testimonials-slider__position">Volunteer</span></div>
										</div>
									</div>
									<div class="testimonials-slider__item">
										<div class="testimonials-slider__icon">“</div>
										<div class="testimonials-slider__text">
											<p>I cannot speak highly enough of Jeevan and the invaluable work they do in promoting organ donation awareness. As a volunteer, I've seen firsthand the dedication and passion that drives this organization. Whether it's through educational workshops, community outreach events, or donor registration campaigns, Jeevan is committed to saving lives and giving hope to those in need.</p>
											<div class="testimonials-slider__author"><span class="testimonials-slider__name">Ninjar Drashti</span><span class="testimonials-slider__position">Volunteer</span></div>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="container margin-top">
						<div class="row margin-bottom">
							<div class="col-lg-4">
								<div class="heading heading--primary"><span class="heading__pre-title">Myths/FAQs</span>
									<h2 class="heading__title no-margin-bottom"><span>Get</span> <span>Awared</span></h2>
								</div>
							</div>
							<div class="col-lg-8">
								<p class="causes__heading-text">In today's digital age, misinformation spreads easily. Protect yourself from being misled by false information. Click here for myth busters and FAQs, and equip yourself with accurate knowledge to make informed decisions. </p><a class="button button--primary d-none d-xl-inline-block" href="faq.php">More Info</a>
							</div>
						</div>
				</div>
				...
				<section class="section instagram no-padding-bottom">
					<div class="container">
						<div class="row align-items-end margin-bottom">
							<div class="col-md-7 col-lg-8">
								<div class="heading heading--primary"><span class="heading__pre-title">Testimonials</span>
									<h2 class="heading__title no-margin-bottom"><span>#donateLife</span></h2>
								</div>
							</div>
					...
					<div class="instagram-slider"><a class="instagram-slider__item" href="#"><img class="img--bg" src="img/pat1.jpg" alt="img"/><span class="instagram-slider__icon"><i class="fa fa-instagram" aria-hidden="true"></i></span><span class="instagram-slider__icon-hover"><i class="fa fa-instagram" aria-hidden="true"></i></span></a><a class="instagram-slider__item" href="#"><img class="img--bg" src="img/pat2.jpg" alt="img"/><span class="instagram-slider__icon"><i class="fa fa-instagram" aria-hidden="true"></i></span><span class="instagram-slider__icon-hover"><i class="fa fa-instagram" aria-hidden="true"></i></span></a><a class="instagram-slider__item" href="#"><img class="img--bg" src="img/pat3.jpg" alt="img"/><span class="instagram-slider__icon"><i class="fa fa-instagram" aria-hidden="true"></i></span><span class="instagram-slider__icon-hover"><i class="fa fa-instagram" aria-hidden="true"></i></span></a><a class="instagram-slider__item" href="#"><img class="img--bg" src="img/pat4.jpg" alt="img"/><span class="instagram-slider__icon"><i class="fa fa-instagram" aria-hidden="true"></i></span><span class="instagram-slider__icon-hover"><i class="fa fa-instagram" aria-hidden="true"></i></span></a><a class="instagram-slider__item" href="#"><img class="img--bg" src="img/pat5.jpg" alt="img"/><span class="instagram-slider__icon"><i class="fa fa-instagram" aria-hidden="true"></i></span><span class="instagram-slider__icon-hover"><i class="fa fa-instagram" aria-hidden="true"></i></span></a></div>
				</section>
				<!-- instagram end-->
				<!-- subscribe start-->
