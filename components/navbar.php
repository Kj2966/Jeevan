		...
		<div class="page-wrapper">
			...
			<div class="aside-dropdown">
				...
				<div class="aside-dropdown__item d-lg-none d-block">
					<ul class="aside-menu">
						<li class="aside-menu__item aside-menu__item--has-child aside-menu__item--active"><a class="aside-menu__link" href="home.php"><span>Home</span></a>
							<!-- sub menu start-->
				...
				<div class="aside-dropdown__item">
					...
					<!-- aside menu end-->
					<div class="aside-inner"><span class="aside-inner__title">Email</span><a class="aside-inner__link" href="mailto:support@helpo.org">support@jeevan.org</a></div>
					<div class="aside-inner"><span class="aside-inner__title">Phone numbers</span><a class="aside-inner__link" href="tel:+180012345678">+910XXX512X9</a><a class="aside-inner__link" href="tel:+18009756511">+910XXX512X9</a></div>
				...
				<a class="button button--squared" href="#" style="margin-top:2px;"><span>Logout</span></a></div>
				...
				<div class="container-fluid">
					<div class="row no-gutters justify-content-between">
						<div class="col-auto d-flex align-items-center">
							...
							<div class="header-logo"><a class="header-logo__link" href="home.php"><img class="header-logo__img logo--light" src="img/logo_white1.png" alt="logo"/><img class="header-logo__img logo--dark" src="img/logo_dark1.png" alt="logo"/></a></div>
						</div>
						<div class="col-auto">
							<!-- main menu start-->
							<nav>
								<ul class="main-menu">
									<li class="main-menu__item main-menu__item--has-child main-menu__item--active"><a class="main-menu__link" href="home.php"><span>Home</span></a>
										<!-- sub menu start-->
